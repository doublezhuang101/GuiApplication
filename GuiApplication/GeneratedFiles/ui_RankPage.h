...
public:
    ...
    void setupUi(QWidget *RankPage)
    {
        if (RankPage->objectName().isEmpty())
            RankPage->setObjectName(QStringLiteral("RankPage"));
        ...
        CstudyButton->setObjectName(QStringLiteral("CstudyButton"));
        ...
        MathButton->setObjectName(QStringLiteral("MathButton"));
